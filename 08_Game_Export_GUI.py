...
from tkinter import *
from functools import partial   # To preven unwanted windows
import random
...
class Game:
    def __init__(self):
        ...
        # In actual program this is blank and is populated with use calculations
...
class Export:
    ...
    def save_history(self, partner, game_history, game_stats):
        ...
        # Regular exporession to check filename is valid
        ...
        if has_error == "yes":
            ...
            self.save_error_label.config(tex="Invalid filename - {}".format(problem))
            # Change entry box background to pink
            self.filename_entry.config(bg="#ffafaf")
            print()

        else:
            # If there are no errors, generate text file and then clopse dialogye
            # add .txt suffix!
