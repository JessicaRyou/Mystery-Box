...
class Game:
    def __init__(self, partner, stakes, starting_balance):
        ...
        self.game_stats_list=[int(starting_balance),starting_balance]
        ...
        # Instructions Label
        self.instructions_label = Label(self.game_frame, width=30, justify=LEFT,
                                        text="Press <enter> or click the 'Open "
                                             "Boxed' button to reveal the "
    ...
    def reveal_boxes(self):
        ...
        for item in range(0, 3):
            ...
            if 0 < prize_num <= 5:
                # prize image references list, meed -1 so position is correct.
...
class Help:
    def __init__(self, partner):
        ...
        help_text="Choose an amount to play with and then choose the stakes. " \
                  ...
                  "boxed. Tp reveal the contents of the boxes, click the" \
...
class GameStats:
    def __init__(self, partner, game_history, game_stats):
        ...
        # If users press cross ar the top, closes help and 'releases' help button
